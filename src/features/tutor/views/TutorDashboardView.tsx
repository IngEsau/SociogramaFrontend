/**
 * Vista del Dashboard de Tutor
 * 
 * Esta es la vista principal para usuarios con rol DOCENTE (tutores).
 * Muestra información relevante para la gestión de grupos y sociogramas.
 */
